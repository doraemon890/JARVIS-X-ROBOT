...
from JARVISROBO import DB_NAME, LOGGER, MONGO_DB_URI

try:
    JARVISROBO_db_client = MongoClient(MONGO_DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
JARVISROBO_main_db = JARVISROBO_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = JARVISROBO_main_db[collection]
    ...
    @staticmethod
    def close():
        return JARVISROBO_db_client.close()
