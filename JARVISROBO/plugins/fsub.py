...
from JARVISROBO import OWNER_ID, tbot
...
__help__ = """
➠ *Jarvis has the capability to hush members who haven't yet subscribed to your channel until they decide to hit that subscribe button.*
