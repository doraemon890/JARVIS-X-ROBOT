...
from JARVISROBO import LOGGER, app, function
...
async def getid(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    sticker_id = (
        "CAACAgUAAxkBAAPFZgABdSgRfzdm7oLaR1by_Xq_gxG8AAKCDwACLMsQV8jnB_KSgJHiHgQ"
    )
...
async def ping(_, m: Message):
    ...
    image_url = "https://telegra.ph/file/50036c4b68c49bf5c4d3e.jpg"
